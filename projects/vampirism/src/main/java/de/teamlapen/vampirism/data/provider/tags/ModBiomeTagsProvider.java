...
public class ModBiomeTagsProvider extends BiomeTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider holderProvider) {
        ...
        tag(ModBiomeTags.HasStructure.VAMPIRE_HUT).add(ModBiomes.VAMPIRE_FOREST);
        ...
        tag(ModBiomeTags.HasStructure.MOTHER).add(ModBiomes.VAMPIRE_FOREST);
        tag(ModBiomeTags.HasStructure.CRYPT).add(ModBiomes.VAMPIRE_FOREST);
