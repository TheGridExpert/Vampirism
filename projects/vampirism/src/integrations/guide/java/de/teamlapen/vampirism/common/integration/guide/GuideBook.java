...
public class GuideBook implements IGuideBook {
    ...
    private static @NotNull Map<Identifier, EntryBase> buildOverview(@NotNull BookHelper helper) {
        ...
        creditsPages.addAll(PageHelper.pagesForLongText(translateComponent(credits, Component.translatable("credits.vampirism.translators"))));
    ...
    private static @NotNull Map<Identifier, EntryBase> buildItems(@NotNull BookHelper helper) {
        ...
        helper.info(ModItems.BASIC_CROSSBOW.get(), ModItems.ENHANCED_CROSSBOW.get(), ModItems.BASIC_DOUBLE_CROSSBOW.get(), ModItems.ENHANCED_DOUBLE_CROSSBOW.get(), ModItems.BASIC_TECH_CROSSBOW.get(), ModItems.ENHANCED_TECH_CROSSBOW.get()).setFormats(loc(ModItems.QUARREL_NORMAL.get()), loc(ModItems.QUARREL_POUCH.get())).setLinks(VIdentifier.mod("guide.vampirism.items.crossbow_arrow_normal")).recipes("basic_crossbow", "enhanced_crossbow", "basic_double_crossbow", "enhanced_double_crossbow", "basic_tech_crossbow", "enhanced_tech_crossbow", "quarrel_pouch").useCustomEntryName().setKeyName("crossbows").build(entries);
        helper.info(ModItems.QUARREL_NORMAL.get(), ModItems.QUARREL_SPITFIRE.get(), ModItems.QUARREL_VAMPIRE_KILLER.get()).recipes("crossbow_arrow_normal", "crossbow_arrow_from_vanilla", "crossbow_arrow_spitfire_1", "crossbow_arrow_vampire_killer_1", "crossbow_arrow_garlic_1", "crossbow_arrow_bleeding_1", "crossbow_arrow_teleport_1").build(entries);
        ...
        helper.info(ModItems.ALCHEMICAL_FIRE.get()).setLinks(VIdentifier.mod("guide.vampirism.items.crossbow_arrow_normal")).recipes("alchemical_fire_4", "alchemical_fire_5", "alchemical_fire_6").build(entries);
