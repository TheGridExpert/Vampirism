...
public class ModDataMapProvider extends DataMapProvider {
    ...
    protected void gatherCompostables(Builder<Compostable, Item> compostables) {
        compostables.add(BuiltInRegistries.ITEM.wrapAsHolder(ModBlocks.VAMPIRE_ORCHID.get().asItem()), new Compostable(0.65F), false);
        compostables.add(BuiltInRegistries.ITEM.wrapAsHolder(ModBlocks.GARLIC.asItem()), new Compostable(0.65f), false);
    }
    ...
    protected void gatherEntityBlood(Builder<IEntityBlood, EntityType<?>> entityValues) {
        ...
        entityValues.add(holder.apply(EntityType.WANDERING_TRADER), new EntityBloodEntry(15), false);
