...
public class BlockStateProvider extends net.neoforged.neoforge.client.model.generators.BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        getVariantBuilder(ModBlocks.MED_CHAIR.get()).forAllStates(blockState -> {
            if (blockState.getValue(MedChairBlock.PART) == MedChairBlock.ChairPart.BOTTOM) {
        ...
        getMultipartBuilder(ModBlocks.HUNTER_TABLE.get())
                ...
                .part().modelFile(hunterTableBottle).rotationY(0).addModel().condition(HunterTableBlock.FACING, Direction.NORTH).condition(HunterTableBlock.VARIANT, HunterTableBlock.TableVariant.POTION, HunterTableBlock.TableVariant.POTION_CAULDRON, HunterTableBlock.TableVariant.WEAPON_POTION, HunterTableBlock.TableVariant.COMPLETE).end()
                .part().modelFile(hunterTableBottle).rotationY(90).addModel().condition(HunterTableBlock.FACING, Direction.EAST).condition(HunterTableBlock.VARIANT, HunterTableBlock.TableVariant.POTION, HunterTableBlock.TableVariant.POTION_CAULDRON, HunterTableBlock.TableVariant.WEAPON_POTION, HunterTableBlock.TableVariant.COMPLETE).end()
                .part().modelFile(hunterTableBottle).rotationY(180).addModel().condition(HunterTableBlock.FACING, Direction.SOUTH).condition(HunterTableBlock.VARIANT, HunterTableBlock.TableVariant.POTION, HunterTableBlock.TableVariant.POTION_CAULDRON, HunterTableBlock.TableVariant.WEAPON_POTION, HunterTableBlock.TableVariant.COMPLETE).end()
                .part().modelFile(hunterTableBottle).rotationY(270).addModel().condition(HunterTableBlock.FACING, Direction.WEST).condition(HunterTableBlock.VARIANT, HunterTableBlock.TableVariant.POTION, HunterTableBlock.TableVariant.POTION_CAULDRON, HunterTableBlock.TableVariant.WEAPON_POTION, HunterTableBlock.TableVariant.COMPLETE).end()
                .part().modelFile(hunterTableGarlic).rotationY(0).addModel().condition(HunterTableBlock.FACING, Direction.NORTH).condition(HunterTableBlock.VARIANT, HunterTableBlock.TableVariant.CAULDRON, HunterTableBlock.TableVariant.POTION_CAULDRON, HunterTableBlock.TableVariant.WEAPON_CAULDRON, HunterTableBlock.TableVariant.COMPLETE).end()
                .part().modelFile(hunterTableGarlic).rotationY(90).addModel().condition(HunterTableBlock.FACING, Direction.EAST).condition(HunterTableBlock.VARIANT, HunterTableBlock.TableVariant.CAULDRON, HunterTableBlock.TableVariant.POTION_CAULDRON, HunterTableBlock.TableVariant.WEAPON_CAULDRON, HunterTableBlock.TableVariant.COMPLETE).end()
                .part().modelFile(hunterTableGarlic).rotationY(180).addModel().condition(HunterTableBlock.FACING, Direction.SOUTH).condition(HunterTableBlock.VARIANT, HunterTableBlock.TableVariant.CAULDRON, HunterTableBlock.TableVariant.POTION_CAULDRON, HunterTableBlock.TableVariant.WEAPON_CAULDRON, HunterTableBlock.TableVariant.COMPLETE).end()
                .part().modelFile(hunterTableGarlic).rotationY(270).addModel().condition(HunterTableBlock.FACING, Direction.WEST).condition(HunterTableBlock.VARIANT, HunterTableBlock.TableVariant.CAULDRON, HunterTableBlock.TableVariant.POTION_CAULDRON, HunterTableBlock.TableVariant.WEAPON_CAULDRON, HunterTableBlock.TableVariant.COMPLETE).end()
