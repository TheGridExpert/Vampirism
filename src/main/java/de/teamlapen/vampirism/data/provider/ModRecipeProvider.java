...
import de.teamlapen.vampirism.data.provider.parent.VampirismRecipeProvider;
...
public class ModRecipeProvider extends VampirismRecipeProvider {
    ...
    private void recipesDecorationalBlocks() {
        ...
        shaped(RecipeCategory.DECORATIONS, ModBlocks.CROSS)
                ...
                .save(output);
        shaped(RecipeCategory.DECORATIONS, ModBlocks.TOMBSTONE_SHORT)
                .pattern("SS")
                .pattern("SS")
                .define('S', Blocks.STONE_SLAB)
                .unlockedBy("has_stone_slab", has(Blocks.STONE_SLAB))
                .save(output);
        shaped(RecipeCategory.DECORATIONS, ModBlocks.TOMBSTONE_MEDIUM)
                .pattern("SS")
                .pattern("SS")
                .pattern("SS")
                .define('S', Blocks.STONE_SLAB)
                .unlockedBy("has_stone_slab", has(Blocks.STONE_SLAB))
                .save(output);
        shaped(RecipeCategory.DECORATIONS, ModBlocks.TOMBSTONE_CROSS)
                .pattern(" S ")
                .pattern("SSS")
                .pattern(" S ")
                .define('S', Blocks.STONE_SLAB)
