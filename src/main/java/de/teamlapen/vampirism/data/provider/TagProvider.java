...
public class TagProvider {
    ...
    public static class ModItemTagsProvider extends ItemTagsProvider {
        ...
        protected void addTags(HolderLookup.@NotNull Provider holderProvider) {
            ...
            copy(ModTags.Blocks.GARLIC, ModTags.Items.GARLIC);
            ...
            tag(ModTags.Items.ARMOR_OF_SWIFTNESS_ULTIMATE).add(ModItems.ARMOR_OF_SWIFTNESS_HEAD_ULTIMATE.get(), ModItems.ARMOR_OF_SWIFTNESS_CHEST_ULTIMATE.get(), ModItems.ARMOR_OF_SWIFTNESS_LEGS_ULTIMATE.get(), ModItems.ARMOR_OF_SWIFTNESS_FEET_ULTIMATE.get());
            tag(ModTags.Items.HUNTER_COAT).addTags(ModTags.Items.HUNTER_COAT_NORMAL, ModTags.Items.HUNTER_COAT_ENHANCED, ModTags.Items.HUNTER_COAT_ULTIMATE);
    ...
    public static class ModEntityTypeTagsProvider extends EntityTypeTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider holderLookup) {
            ...
            tag(ModTags.Entities.COMPARE_DEFENDING_HUNTERS).add(ModEntities.HUNTER.get(), ModEntities.HUNTER_IMOB.get(), ModEntities.ADVANCED_HUNTER.get(), ModEntities.ADVANCED_HUNTER_IMOB.get());
            tag(ModTags.Entities.COMPARE_DEFENDING_VAMPIRES).add(ModEntities.VAMPIRE.get(), ModEntities.VAMPIRE_IMOB.get(), ModEntities.ADVANCED_VAMPIRE.get(), ModEntities.ADVANCED_VAMPIRE_IMOB.get());
