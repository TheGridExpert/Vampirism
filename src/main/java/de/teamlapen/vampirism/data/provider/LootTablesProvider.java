...
public class LootTablesProvider {
    ...
    private static class ModBlockLootTables extends BlockLootSubProvider {
        ...
        protected void generate() {
            ...
            this.add(ModBlocks.MED_CHAIR.get(), block -> createSinglePropConditionTable(block, MedChairBlock.PART, MedChairBlock.ChairPart.BOTTOM));
        ...
        public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> consumer) {
            ...
            consumer.accept(ModLootTables.DESERT_PYRAMID, LootTable.lootTable()
                    .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1))
                            ...
                            .add(LootItem.lootTableItem(ModItems.BLOOD_BOTTLE.get()).setWeight(20).apply(SetBloodFunction.builder(6, 9)))
