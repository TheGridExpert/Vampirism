...
public class ModBiomeTagsProvider extends BiomeTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider holderProvider) {
        ...
        tag(ModBiomeTags.HasStructure.HUNTER_CAMP).addTags(Tags.Biomes.IS_DESERT, Tags.Biomes.IS_PLAINS, Tags.Biomes.IS_SNOWY_PLAINS, Tags.Biomes.IS_PLATEAU, Tags.Biomes.IS_BADLANDS, Tags.Biomes.IS_FOREST, Tags.Biomes.IS_TAIGA).add(Biomes.SPARSE_JUNGLE).remove(ModBiomeTags.HasFaction.IS_FACTION_BIOME).remove(Biomes.PALE_GARDEN);
