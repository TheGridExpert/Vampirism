...
public class ModTasks {
    ...
    static void createTasks(BootstrapContext<Task> context) {
        ...
        context.register(RANDOM_REFINEMENT_3, TaskBuilder.builder(RANDOM_REFINEMENT_3).defaultTitle().addRequirement(Stats.TRADED_WITH_VILLAGER, 15).addRequirement(new ItemStack(Items.GOLD_INGOT, 2)).setReward(new RefinementItemReward(VReference.VAMPIRE_FACTION)).build());
        ...
        context.register(FIRE_RESISTANCE_1, TaskBuilder.builder(FIRE_RESISTANCE_1).defaultTitle().addRequirement(new ItemStack(Items.MAGMA_CREAM, 3)).addRequirement(ModTags.Entities.HUNTER, 10).setReward(ItemDataUtils.createPotion(ModPotions.VAMPIRE_FIRE_RESISTANCE)).build());
        context.register(FIRE_RESISTANCE_2, TaskBuilder.builder(FIRE_RESISTANCE_2).defaultTitle().unlockedBy(new LvlUnlocker(7)).addRequirement(new ItemStack(Items.MAGMA_CREAM, 5)).addRequirement(ModTags.Entities.HUNTER, 15).setReward(ItemDataUtils.createPotion(ModPotions.LONG_VAMPIRE_FIRE_RESISTANCE)).build());
        ...
        context.register(HUNTER_LORD_1, TaskBuilder.builder(HUNTER_LORD_1).defaultTitle().unlockedBy(new LvlUnlocker(VReference.HUNTER_FACTION.getHighestReachableLevel())).addRequirement(ModTags.Entities.VAMPIRE, 50).addRequirement(new ItemStack(Items.GOLD_INGOT, 32)).addRequirement(ModStats.WIN_VILLAGE_CAPTURE.get(), 3).setReward(new LordLevelReward(1, Component.translatable("task.vampirism.hunter_lord1.reward"))).build());
        ...
        context.register(HUNTER_LORD_5, TaskBuilder.builder(HUNTER_LORD_5).defaultTitle().unlockedBy(new LordLvlUnlocker(4, true)).addRequirement(ModTags.Entities.VAMPIRE, 100).addRequirement(new ItemStack(Items.GOLD_INGOT, 64)).addRequirement(ModStats.CAPTURE_VILLAGE.get(), 6).setReward(new LordLevelReward(5)).build());
