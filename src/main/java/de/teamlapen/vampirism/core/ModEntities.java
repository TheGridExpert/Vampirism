...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Hunter>> NEW_HUNTER = registerEntityType("hunter_new", Hunter::new, VEnums.HUNTER_CATEGORY.getValue(), builder -> builder.sized(0.6F, 1.95F));

    public static final DeferredHolder<EntityType<?>, EntityType<OldBasicHunterEntity>> HUNTER = registerEntityType("hunter", OldBasicHunterEntity::new, VEnums.HUNTER_CATEGORY.getValue(), (d) -> d.sized(0.6F, 1.95F));
    public static final DeferredHolder<EntityType<?>, EntityType<OldHunterTrainerEntity>> HUNTER_TRAINER = registerEntityType("hunter_trainer", OldHunterTrainerEntity::new, VEnums.HUNTER_CATEGORY.getValue(), (b) -> b.sized(0.6F, 1.95F));
    public static final DeferredHolder<EntityType<?>, EntityType<OldAdvancedHunterEntity>> ADVANCED_HUNTER = registerEntityType("advanced_hunter", OldAdvancedHunterEntity::new, VEnums.HUNTER_CATEGORY.getValue(), b -> b.sized(0.6F, 1.95F));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<OldAdvancedHunterEntity.IMob>> ADVANCED_HUNTER_IMOB = registerEntityType("advanced_hunter_imob", OldAdvancedHunterEntity.IMob::new, VEnums.HUNTER_CATEGORY.getValue(), x -> x.sized(0.6f, 1.95f).noSummon());
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<OldDummyHunterTrainerEntity>> HUNTER_TRAINER_DUMMY = registerEntityType("hunter_trainer_dummy", OldDummyHunterTrainerEntity::new, MobCategory.MISC, x -> x.sized(0.6F, 1.95F));
    public static final DeferredHolder<EntityType<?>, EntityType<AreaParticleCloudEntity>> PARTICLE_CLOUD = registerEntityType("particle_cloud", AreaParticleCloudEntity::new, MobCategory.MISC, x -> x.sized(6.0F, 0.5F).fireImmune().noSummon());
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<OldBasicHunterEntity.IMob>> HUNTER_IMOB = registerEntityType("hunter_imob", OldBasicHunterEntity.IMob::new, VEnums.HUNTER_CATEGORY.getValue(), x -> x.sized(0.6f, 1.95f).noSummon());
    public static final DeferredHolder<EntityType<?>, EntityType<OldAggressiveVillagerEntity>> VILLAGER_ANGRY = registerEntityType("villager_angry", OldAggressiveVillagerEntity::new, MobCategory.CREATURE, x -> x.sized(0.6F, 1.95F).noSummon());
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<OldHunterTaskMasterEntity>> TASK_MASTER_HUNTER = registerEntityType("task_master_hunter", OldHunterTaskMasterEntity::new, VEnums.HUNTER_CATEGORY.getValue(), x -> x.sized(0.6f, 1.95f));
    ...
    static void onRegisterSpawns(@NotNull RegisterSpawnPlacementsEvent event) {
        event.register(NEW_HUNTER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Hunter::checkHunterSpawnRules, RegisterSpawnPlacementsEvent.Operation.OR);

        event.register(ADVANCED_HUNTER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, OldHunterBaseEntity::spawnPredicateHunter, RegisterSpawnPlacementsEvent.Operation.OR);
        ...
        event.register(HUNTER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, OldHunterBaseEntity::spawnPredicateHunter, RegisterSpawnPlacementsEvent.Operation.OR);
    ...
    static void onRegisterEntityTypeAttributes(@NotNull EntityAttributeCreationEvent event) {
        event.put(NEW_HUNTER.get(), Hunter.getAttributeBuilder().build());

        event.put(ADVANCED_HUNTER.get(), OldAdvancedHunterEntity.getAttributeBuilder().build());
        event.put(ADVANCED_HUNTER_IMOB.get(), OldAdvancedHunterEntity.getAttributeBuilder().build());
        ...
        event.put(HUNTER.get(), OldBasicHunterEntity.getAttributeBuilder().build());
        event.put(HUNTER_IMOB.get(), OldBasicHunterEntity.getAttributeBuilder().build());
        event.put(HUNTER_TRAINER.get(), OldHunterTrainerEntity.getAttributeBuilder().build());
        event.put(HUNTER_TRAINER_DUMMY.get(), OldHunterTrainerEntity.getAttributeBuilder().build());
        ...
        event.put(VILLAGER_ANGRY.get(), OldAggressiveVillagerEntity.getAttributeBuilder().build());
        ...
        event.put(TASK_MASTER_HUNTER.get(), OldHunterTaskMasterEntity.getAttributeBuilder().build());
        ...
        event.put(VULNERABLE_REMAINS_DUMMY.get(), VulnerableRemainsDummyEntity.getAttributeBuilder().build());
        event.put(REMAINS_DEFENDER.get(), RemainsDefenderEntity.getAttributeBuilder().build());
        event.put(GHOST.get(), GhostEntity.getAttributeBuilder().build());
