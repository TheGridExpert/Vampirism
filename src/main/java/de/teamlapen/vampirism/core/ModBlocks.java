...
import de.teamlapen.vampirism.blocks.diffuser.GarlicDiffuserCoreBlock;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<GarlicDiffuserCoreBlock> GARLIC_DIFFUSER_CORE = registerWithItem("garlic_diffuser_core", props -> new GarlicDiffuserCoreBlock(props, EnumStrength.WEAK), () -> copyProperties(Blocks.WHITE_WOOL));
    public static final DeferredBlock<GarlicDiffuserCoreBlock> GARLIC_DIFFUSER_CORE_IMPROVED = registerWithItem("garlic_diffuser_core_improved", props -> new GarlicDiffuserCoreBlock(props, EnumStrength.MEDIUM), () -> copyProperties(Blocks.LIGHT_BLUE_WOOL));
    ...
    public static final DeferredBlock<HorizontalWaterloggedBlock> TOMBSTONE_SHORT = registerWithItem("tombstone_short", props -> new HorizontalWaterloggedBlock(props, VampirismVoxelShapes.TOMBSTONE_SHORT), () -> copyProperties(Blocks.COBBLESTONE));
    public static final DeferredBlock<HorizontalWaterloggedBlock> TOMBSTONE_MEDIUM = registerWithItem("tombstone_medium", props -> new HorizontalWaterloggedBlock(props, VampirismVoxelShapes.TOMBSTONE_MEDIUM), () -> copyProperties(Blocks.COBBLESTONE));
    public static final DeferredBlock<WaterloggedSplitBlock> TOMBSTONE_CROSS = registerWithItem("tombstone_cross", props -> new WaterloggedSplitBlock(props, VampirismVoxelShapes.TOMBSTONE_CROSS_BOTTOM, VampirismVoxelShapes.TOMBSTONE_CROSS_TOP, true), () -> copyProperties(Blocks.COBBLESTONE).pushReaction(PushReaction.DESTROY));
    public static final DeferredBlock<HorizontalWaterloggedBlock> GRAVE_CAGE = registerWithItem("grave_cage", props -> new HorizontalWaterloggedBlock(props, VampirismVoxelShapes.GRAVE_CAGE), () -> basicProperties().mapColor(MapColor.METAL).strength(6, 8).requiresCorrectToolForDrops().sound(SoundType.METAL));
