...
public class ModItems {
    ...
    public static final DeferredItem<HunterHatItem> HUNTER_HAT_TALL = ITEMS.registerItem("hunter_hat_tall",  props -> new HunterHatItem(ModArmorMaterials.HUNTER_HAT_TALL, props));
    public static final DeferredItem<HunterHatItem> HUNTER_HAT_BROAD = ITEMS.registerItem("hunter_hat_broad",  props -> new HunterHatItem(ModArmorMaterials.HUNTER_HAT_BROAD, props));
    ...
    // General
    public static final DeferredItem<BloodBottleItem> BLOOD_BOTTLE = ITEMS.registerItem("blood_bottle",  props -> new BloodBottleItem(props.stacksTo(1).component(DataComponents.CONSUMABLE, Consumables.defaultDrink().build())));
