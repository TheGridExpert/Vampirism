...
public class ModItems {
    ...
    public static final DeferredItem<SpawnEggItem> ADVANCED_VAMPIRE_SPAWN_EGG = register("advanced_vampire_spawn_egg", null, () -> new DeferredSpawnEggItem(ModEntities.ADVANCED_VAMPIRE, 0x881d99, 0xeaa340, new Item.Properties()));
    ...
    public static final DeferredItem<SpawnEggItem> ADVANCED_VAMPIRE_HUNTER_SPAWN_EGG = register("advanced_vampire_hunter_spawn_egg", null, () -> new DeferredSpawnEggItem(ModEntities.ADVANCED_HUNTER, 0x173f9c, 0xeaa340, new Item.Properties()));
