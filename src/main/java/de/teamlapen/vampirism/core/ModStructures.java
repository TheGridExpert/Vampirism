...
public class ModStructures {
    ...
    public static final DeferredHolder<StructurePieceType, StructurePieceType> HUNTER_CAMP_PIECE = STRUCTURE_PIECES.register("hunter_camp", () -> (StructurePieceType.StructureTemplateType) HunterCampPieces.HunterCampPiece::new);
    public static final DeferredHolder<StructurePieceType, StructurePieceType> HUNTER_CAMP_FLAG_PIECE = STRUCTURE_PIECES.register("hunter_camp_flag", () -> (StructurePieceType.StructureTemplateType) HunterCampPieces.FlagPiece::new);
    ...
    public static final ResourceKey<StructureSet> HUNTER_OUTPOST_SET = createStructureSetKey("hunter_outpost");
    ...
    static void createStructureSets(BootstrapContext<StructureSet> context) {
        ...
        var villageSet = setLookup.getOrThrow(BuiltinStructureSets.VILLAGES);

        // actual numbers are: 9, 6
        context.register(HUNTER_CAMP_SET, new StructureSet(structureLookup.getOrThrow(HUNTER_CAMP), new RandomSpreadStructurePlacement(Vec3i.ZERO, StructurePlacement.FrequencyReductionMethod.DEFAULT, 1.0F, 1724616580, Optional.of(new StructurePlacement.ExclusionZone(villageSet, 4)), 4, 3, RandomSpreadType.LINEAR)));
        context.register(HUNTER_OUTPOST_SET, new StructureSet(List.of(StructureSet.entry(structureLookup.getOrThrow(HUNTER_OUTPOST_PLAINS)), StructureSet.entry(structureLookup.getOrThrow(HUNTER_OUTPOST_DESERT)), StructureSet.entry(structureLookup.getOrThrow(HUNTER_OUTPOST_VAMPIRE_FOREST)), StructureSet.entry(structureLookup.getOrThrow(HUNTER_OUTPOST_BADLANDS))), new RandomSpreadStructurePlacement(Vec3i.ZERO, StructurePlacement.FrequencyReductionMethod.DEFAULT, 1.0F, 36413509, Optional.of(new StructurePlacement.ExclusionZone(villageSet, 4)), 45, 25, RandomSpreadType.LINEAR)));
    ...
    static void createStructures(BootstrapContext<Structure> context) {
        ...
        context.register(HUNTER_CAMP, new HunterCampStructure(new Structure.StructureSettings.Builder(biomeLookup.getOrThrow(ModBiomeTags.HasStructure.HUNTER_CAMP)).generationStep(GenerationStep.Decoration.SURFACE_STRUCTURES).terrainAdapation(TerrainAdjustment.NONE).build()));
        //context.register(HUNTER_CAMP, new AltHunterCampStructure(new Structure.StructureSettings.Builder(biomeLookup.getOrThrow(ModBiomeTags.HasStructure.HUNTER_CAMP)).generationStep(GenerationStep.Decoration.SURFACE_STRUCTURES).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(), poolLookup.getOrThrow(AltHunterCampPools.START)));
        context.register(HUNTER_OUTPOST_PLAINS, new JigsawStructure(new Structure.StructureSettings.Builder(biomeLookup.getOrThrow(ModBiomeTags.HasStructure.HUNTER_OUTPOST_PLAINS)).spawnOverrides(Map.of(VEnums.HUNTER_CATEGORY.getValue(), new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedRandomList.create(new MobSpawnSettings.SpawnerData(ModEntities.HUNTER.get(), 80, 2, 4), new MobSpawnSettings.SpawnerData(ModEntities.ADVANCED_HUNTER.get(), 20, 1, 22))))).generationStep(GenerationStep.Decoration.SURFACE_STRUCTURES).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(), poolLookup.getOrThrow(PlainsHunterOutpostPools.START), 10, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
        context.register(HUNTER_OUTPOST_DESERT, new JigsawStructure(new Structure.StructureSettings.Builder(biomeLookup.getOrThrow(ModBiomeTags.HasStructure.HUNTER_OUTPOST_DESERT)).spawnOverrides(Map.of(VEnums.HUNTER_CATEGORY.getValue(), new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedRandomList.create(new MobSpawnSettings.SpawnerData(ModEntities.HUNTER.get(), 80, 2, 4), new MobSpawnSettings.SpawnerData(ModEntities.ADVANCED_HUNTER.get(), 20, 1, 22))))).generationStep(GenerationStep.Decoration.SURFACE_STRUCTURES).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(), poolLookup.getOrThrow(DesertHunterOutpostPools.START), 10, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
        context.register(HUNTER_OUTPOST_VAMPIRE_FOREST, new JigsawStructure(new Structure.StructureSettings.Builder(biomeLookup.getOrThrow(ModBiomeTags.HasStructure.HUNTER_OUTPOST_VAMPIRE_FOREST)).spawnOverrides(Map.of(VEnums.HUNTER_CATEGORY.getValue(), new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedRandomList.create(new MobSpawnSettings.SpawnerData(ModEntities.HUNTER.get(), 80, 2, 4), new MobSpawnSettings.SpawnerData(ModEntities.ADVANCED_HUNTER.get(), 20, 1, 22))))).generationStep(GenerationStep.Decoration.SURFACE_STRUCTURES).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(), poolLookup.getOrThrow(VampireForestHunterOutpostPools.START), 10, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
        context.register(HUNTER_OUTPOST_BADLANDS, new JigsawStructure(new Structure.StructureSettings.Builder(biomeLookup.getOrThrow(ModBiomeTags.HasStructure.HUNTER_OUTPOST_BADLANDS)).spawnOverrides(Map.of(VEnums.HUNTER_CATEGORY.getValue(), new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedRandomList.create(new MobSpawnSettings.SpawnerData(ModEntities.HUNTER.get(), 80, 2, 4), new MobSpawnSettings.SpawnerData(ModEntities.ADVANCED_HUNTER.get(), 20, 1, 22))))).generationStep(GenerationStep.Decoration.SURFACE_STRUCTURES).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(), poolLookup.getOrThrow(BadlandsHunterOutpostPools.START), 10, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
        context.register(VAMPIRE_ALTAR, new VampireAltarStructure(new Structure.StructureSettings.Builder(biomeLookup.getOrThrow(ModBiomeTags.HasStructure.VAMPIRE_ALTAR)).terrainAdapation(TerrainAdjustment.BEARD_BOX).build()));
        context.register(VAMPIRE_HUT, new VampireHutStructure(new Structure.StructureSettings.Builder(biomeLookup.getOrThrow(ModBiomeTags.HasStructure.VAMPIRE_HUT)).terrainAdapation(TerrainAdjustment.NONE).build()));
        context.register(MOTHER, new MotherStructure(new Structure.StructureSettings.Builder(biomeLookup.getOrThrow(ModBiomeTags.HasStructure.MOTHER)).terrainAdapation(TerrainAdjustment.NONE).build()));
        context.register(CRYPT, new JigsawStructure(new Structure.StructureSettings.Builder(biomeLookup.getOrThrow(ModBiomeTags.HasStructure.CRYPT)).terrainAdapation(TerrainAdjustment.BEARD_THIN).build(), poolLookup.getOrThrow(CryptStructurePieces.START), Optional.empty(), 9, ConstantHeight.of(VerticalAnchor.absolute(0)), false, Optional.of(Heightmap.Types.WORLD_SURFACE_WG), 80, List.of(), DimensionPadding.ZERO, LiquidSettings.IGNORE_WATERLOGGING));
    }
}
