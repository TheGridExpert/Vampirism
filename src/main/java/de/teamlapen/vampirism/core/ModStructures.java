...
public class ModStructures {
    ...
    static void createStructureSets(BootstrapContext<StructureSet> context) {
        ...
        context.register(HUNTER_CAMP_SET, new StructureSet(structureLookup.getOrThrow(HUNTER_CAMP), new RandomSpreadStructurePlacement(Vec3i.ZERO, StructurePlacement.FrequencyReductionMethod.DEFAULT, 1.0F, 1724616580, Optional.of(new StructurePlacement.ExclusionZone(villageSet, 3)), 4, 3, RandomSpreadType.LINEAR)));
