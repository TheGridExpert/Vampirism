...
public class ModMemoryModuleTypes {
    ...
    public static final DeferredHolder<MemoryModuleType<?>, MemoryModuleType<LivingEntity>> CURE_TARGET = registerMemory("cure_target");
    public static final DeferredHolder<MemoryModuleType<?>, MemoryModuleType<Integer>> SEE_TIME = registerMemory("see_time");
