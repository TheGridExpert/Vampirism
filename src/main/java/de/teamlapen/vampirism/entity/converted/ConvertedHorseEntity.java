...
public class ConvertedHorseEntity extends Horse implements CurableConvertedCreature<Horse, ConvertedHorseEntity> {
    ...
    public static boolean checkConvertedHorseSpawnRules(EntityType<? extends Animal> pGoat, LevelAccessor pLevel, EntitySpawnReason pSpawnType, BlockPos pPos, RandomSource pRandom) {
