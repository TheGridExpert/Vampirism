...
public class MinionTasks {
    ...
    public static final DeferredHolder<IMinionTask<?,?>,CollectResourcesTask<HunterMinionEntity.HunterMinionData>> COLLECT_HUNTER_ITEMS = MINION_TASKS.register("collect_hunter_items", () -> new CollectResourcesTask<>(ModFactions.HUNTER, data -> (int) (VampirismConfig.BALANCE.miResourceCooldown.get() * (1f - data.getResourceEfficiencyLevel() / (float) HunterMinionEntity.HunterMinionData.MAX_LEVEL_RESOURCES * 0.4f)), Arrays.asList(WeightedEntry.wrap(new ItemStack(ModItems.GARLIC_BREAD.get()), 10), WeightedEntry.wrap(new ItemStack(Items.IRON_NUGGET, 19), 25), WeightedEntry.wrap(new ItemStack(Items.GOLD_NUGGET, 7), 10), WeightedEntry.wrap(new ItemStack(ModBlocks.GARLIC.get(), 2), 15), WeightedEntry.wrap(new ItemStack(Items.COAL, 5), 20)), HunterSkills.MINION_COLLECT));
    public static final DeferredHolder<IMinionTask<?,?>,CollectResourcesTask<VampireMinionEntity.VampireMinionData>> COLLECT_BLOOD = MINION_TASKS.register("collect_blood", () -> new CollectResourcesTask<>(ModFactions.VAMPIRE, data -> VampirismConfig.BALANCE.miResourceCooldown.get(), Arrays.asList(WeightedEntry.wrap(BloodBottleItem.getStackWithBlood(BloodBottleItem.AMOUNT), 20), WeightedEntry.wrap(new ItemStack(ModItems.HUMAN_HEART.get()), 5), WeightedEntry.wrap(new ItemStack(Items.IRON_NUGGET, 12), 12), WeightedEntry.wrap(new ItemStack(Items.GOLD_NUGGET, 6), 10)), VampireSkills.MINION_COLLECT));
