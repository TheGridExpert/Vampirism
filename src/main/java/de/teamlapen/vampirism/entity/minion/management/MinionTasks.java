...
public class MinionTasks {
    ...
    public static final DeferredHolder<IMinionTask<?,?>,CollectResourcesTask<VampireMinionEntity.VampireMinionData>> COLLECT_BLOOD = MINION_TASKS.register("collect_blood", () -> new CollectResourcesTask<>(VReference.VAMPIRE_FACTION, data -> VampirismConfig.BALANCE.miResourceCooldown.get(), Arrays.asList(WeightedEntry.wrap(BloodBottleItem.getStackWithBlood(BloodBottleItem.AMOUNT), 20), WeightedEntry.wrap(new ItemStack(ModItems.HUMAN_HEART.get()), 5), WeightedEntry.wrap(new ItemStack(Items.IRON_NUGGET, 12), 12), WeightedEntry.wrap(new ItemStack(Items.GOLD_NUGGET, 6), 10)), VampireSkills.MINION_COLLECT));
